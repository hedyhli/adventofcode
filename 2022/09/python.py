s01 = lambda n: 1 if n != 0 else 0  # hmm (n//(n-1) or n//2 or 0) works but longer than this
...
# goal: short/minimal but NOT golf
# like golf, but not optimized for it (I only strip whitespace when I feel needed)
# memory and run time taken into consideration.
# SEE python-long.py for a more wholesome version lol
